    ...
    <Layout>
      <div className="space-y-4 lg:space-y-6">
          ...
          <Dialog open={isUploadOpen} onOpenChange={setIsUploadOpen}>
            ...
            <DialogContent className="max-w-lg">
              <DialogHeader>
                ...
                <DialogDescription>
                  Upload documents, photos, or other project files with optional
        ...
        <div
          className={
            viewMode === "grid"
              ? "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-6 gap-6"
              : "space-y-4"
          }
        >
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                ...
                <div>
                  <div className="text-2xl font-bold text-purple-600">
                    {
                      files.filter((f) => f.mime_type.startsWith("video/"))
                        .length
                    }
                  </div>
