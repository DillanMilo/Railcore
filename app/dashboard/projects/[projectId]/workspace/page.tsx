...
export default function ProjectWorkspacePage() {
  ...
  const handleCompleteProject = async () => {
    ...
    const confirmed = confirm(
      "Are you sure you want to mark this project as completed? This will send it to the repository."
    );
    if (!confirmed) return;
              ...
              >
                ...
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Add a note, observation, issue, or progress update to this
                      project.
                    </DialogDescription>
                  </DialogHeader>
                  <form onSubmit={handleCreateNote} className="space-y-4">
                    ...
                    <div>
                      ...
                      <Select
                        value={noteType}
                        onValueChange={(value: ProjectNote["type"]) =>
                          setNoteType(value)
                        }
                      >
                        <SelectTrigger>
