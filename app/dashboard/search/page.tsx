...
export default function SearchPage() {
  ...
  const getNoteTypeIcon = (type: ProjectNote["type"]) => {
    switch (type) {
      ...
      default:
        return <StickyNote className="h-4 w-4 text-gray-500" />;
    }
  };
                            ...
                            <div className="flex items-center justify-between text-xs text-gray-500">
                              ...
                              {item.location && (
                                <div className="flex items-center">
                                  ...
                                  GPS: {item.location.lat.toFixed(4)},{" "}
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                ...
                <div>
                  <div className="text-2xl font-bold text-green-600">
                    {
                      new Set([
                        ...searchResults.notes.map((n) => n.project_id),
                        ...searchResults.media.map((m) => m.project_id),
                      ]).size
                    }
                  </div>
                ...
                <div>
                  <div className="text-2xl font-bold text-orange-600">
                    {
                      searchResults.notes.filter((n) => n.weather_conditions)
                        .length
                    }
                  </div>
