  ...
  const integrations: AppIntegration[] = [
    {
      ...
      description: 'Connect with EarthCam systems for automated photo capture and time-lapse documentation.',
      category: 'productivity',
      status: 'coming_soon',
      icon: Camera,
      features: ['Automated photo capture', 'Time-lapse creation', 'Weather overlay', 'Progress tracking']
    },
    {
      id: '2',
      name: 'GPS Mapping Tools',
      description: 'Advanced GPS and mapping tools for precise location tracking and surveying.',
      category: 'mapping',
      status: 'available',
      icon: MapPin,
      features: ['GPS coordinates', 'Site mapping', 'Progress visualization', 'Location tagging']
    },
    {
      id: '3',
      name: 'Advanced Analytics',
      description: 'Comprehensive reporting and analytics dashboard for project insights.',
      category: 'reporting',
      status: 'beta',
      icon: BarChart3,
      features: ['Custom dashboards', 'Trend analysis', 'Performance metrics', 'Export capabilities']
    },
    {
      id: '4',
      name: 'Excel Integration',
      description: 'Import and export data to Microsoft Excel for advanced analysis and reporting.',
      category: 'productivity',
      status: 'available',
      icon: FileSpreadsheet,
      features: ['Data import/export', 'Template sync', 'Bulk operations', 'Formula support']
    },
    {
      id: '5',
      name: 'Mobile App',
      ...
      status: 'coming_soon',
      icon: Smartphone,
      features: ['Offline mode', 'Photo capture', 'GPS tracking', 'Push notifications']
    },
    {
      id: '6',
      name: 'Cloud Backup',
      description: 'Automated cloud backup and disaster recovery for all project data.',
      category: 'integration',
      status: 'available',
      icon: Cloud,
      features: ['Automated backups', 'Point-in-time recovery', 'Multi-region storage', 'Encryption']
    }
  ];
      ...
      <div className="space-y-6">
        ...
        <div className="text-center">
          ...
          <p className="mt-1 text-sm text-gray-500">
            Additional tools and integrations to enhance your RailCore experience
          </p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <Button variant="outline" className="justify-start h-auto p-4">
                <div className="text-left">
                  ...
                  <div className="text-xs text-gray-500">Create sample data</div>
                </div>
              </Button>
              ...
              <Button variant="outline" className="justify-start h-auto p-4">
                <div className="text-left">
                  ...
                  <div className="text-xs text-gray-500">Download project data</div>
                </div>
              </Button>
